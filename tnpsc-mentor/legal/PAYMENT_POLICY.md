...
This Payment Policy explains what we sell, what it costs, how long access lasts, and how payment is taken. How you pay depends on where you are using the service — the website takes payment directly, while the Android and iOS apps must use the app stores' own billing.

## 1. The free tier and credits
