...
# Return & Cancellation Policy — TNPSC Mentors
...
This policy explains refunds and cancellations. Who processes a refund depends on where you bought: we handle website purchases ourselves, but purchases made inside the Android or iOS apps are refunded by Google or Apple under their own policies, because they, not we, took the payment.

## 1. Digital content — the general rule
...
## 2. Where to ask, depending on how you paid
...
## 3. When you are eligible (website purchases)
...
## 5. How to request (website purchases)

Email support@tnpscmentors.in, or WhatsApp +91 96777 79808, within 7 days of the transaction, with: your registered name, the email or phone on the account, the payment or order reference, the date and amount, and the reason. We aim to decide within 7 business days and will tell you the outcome either way.
...
© 2026 TNPSC Mentors. An independent preparation product — not affiliated with, endorsed by, or connected to the Tamil Nadu Public Service Commission.
